            ...
            <nav className={`${activemobile ? 'block' : 'hidden'} fixed bg-black/90 md:bg-black h-full w-full md:w-[15rem] z-30 md:block`}>
                ...
                >
                    <Link to="/" className="logo flex flex-col justify-center items-center m-7 gap-2" onClick={() => setActivemobile(!activemobile)}>
                        ...
                        <h1 className="text-gray-400/70 font-bold text-2xl text-center">BlackList Movies</h1>
                    </Link>
                </motion.div>
                ...
                <br /><br /><br /><br /><br />
                <br /><br />
                        <div className="text-white font-semibold text-[16px] text-center px-5">
                            <span>Developer :- Shreyash Kumar Agnihotri</span>
                        </div>
                {/* Loginsection */}
